 ...
 */
export function getVoiceCharacteristics(voiceName) {
    return VOICE_CHARACTERISTICS[voiceName.toLowerCase()];
}
/**
 * Check if a voice name is valid
 */
export function isValidVoiceName(voiceName) {
    if (!voiceName)
        return false;
 ...
 */
export function sanitizeVoiceName(voiceName) {
    if (!voiceName)
        return undefined;
 ...
 */
export function getVoicePronoun(voiceName, type) {
...
//# sourceMappingURL=voice-characteristics.js.map